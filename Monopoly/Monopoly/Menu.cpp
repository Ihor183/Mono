...
void Menu::setImage() {
	...
	for(int i = 0; i < 36; i++) tex_check[i].loadFromFile("images/check.png");
	for (int i = 0; i < 28; i++) tex_image[i].loadFromFile("images/Firm" + toStr(i + 1) + ".png");
	for (int i = 0; i < 5; i++) tex_helpInstrument[i].loadFromFile("images/i" + toStr(i + 1) + ".png");


	spr_Background.setTexture(tex_Background);
	spr_Background.setPosition(0, 0);
	spr_Background.setScale(Vector2f(2.f, 2.f));
	for (int i = 0; i < 36; i++) { spr_check[i].setTexture(tex_check[i]); spr_check[i].setScale(Vector2f(0.1f, 0.1f)); }
	for (int i = 0; i < 28; i++) { spr_image[i].setTexture(tex_image[i]); spr_image[i].setScale(Vector2f(0.31f, 0.4f)); }
	for (int i = 0; i < 5; i++) spr_helpInstrument[i].setTexture(tex_helpInstrument[i]);
}
...
void Menu::trade(RenderWindow &window, Player *player, Map &map, int Size, int CurrentPlayer, int* Firm, vector<Sprite> spr_token, Text *money) {
	...
	int *arr, *arr1, size1, numPlayer = 0, pl = 0;
	bool isClick = false, isChecked[36];
	int size = player[CurrentPlayer].getSize();
	arr = new int[size];

	for (int i = 0; i < 36; i++) isChecked[i] = false;
	...
	spr_helpInstrument[2].setPosition(900, 500);
	...
	while (window.isOpen() && isMenu)
	{
		...
		if (IntRect(900, 500, 58, 58).contains(Mouse::getPosition(window))) menuNum = 7;
		...
		if (IntRect(100, 0, 100, 185).contains(Mouse::getPosition(window)) && size > 0) pos = 2;
		if (IntRect(200, 0, 100, 185).contains(Mouse::getPosition(window)) && size > 1) pos = 3;
		if (IntRect(300, 0, 100, 185).contains(Mouse::getPosition(window)) && size > 2) pos = 4;
		if (IntRect(400, 0, 100, 185).contains(Mouse::getPosition(window)) && size > 3) pos = 5;
		if (IntRect(500, 0, 100, 185).contains(Mouse::getPosition(window)) && size > 4) pos = 6;
		if (IntRect(0, 0, 100, 185).contains(Mouse::getPosition(window)) && size > 5) pos = 7;
		if (IntRect(100, 187, 100, 185).contains(Mouse::getPosition(window)) && size > 6) pos = 8;
		...
		if (IntRect(0, 372, 100, 185).contains(Mouse::getPosition(window)) && size > 7) pos = 13;
		if (IntRect(100, 372, 100, 185).contains(Mouse::getPosition(window)) && size > 12) pos = 14;
		if (IntRect(200, 372, 100, 185).contains(Mouse::getPosition(window)) && size > 13) pos = 15;
		if (IntRect(300, 372, 100, 185).contains(Mouse::getPosition(window)) && size > 14) pos = 16;
		if (IntRect(400, 372, 100, 185).contains(Mouse::getPosition(window)) && size > 15) pos = 17;
		if (IntRect(500, 372, 100, 185).contains(Mouse::getPosition(window)) && size > 16) pos = 18;
		if (Mouse::isButtonPressed(Mouse::Left)) {
			if (pos == 1 && isChecked[0] == false) { spr_check[0].setPosition(0, 0); numChecks.push_back(pos); isChecked[0] = true; }
			else if (pos == 1) { for (it = numChecks.begin(); it != numChecks.end(); it++) { 
			...
			else if (pos == 2) { for (it = numChecks.begin(); it != numChecks.end(); it++) {
					if (*it == pos) it = numChecks.erase(it);
					if (it == numChecks.end()) break;
				}
				isChecked[1] = false;
		...
		if (IntRect(850, 0, 100, 185).contains(Mouse::getPosition(window)) && size1 > 0) pos1 = 2;
		if (IntRect(950, 0, 100, 185).contains(Mouse::getPosition(window)) && size1 > 1) pos1 = 3;
		if (IntRect(1050, 0, 100, 185).contains(Mouse::getPosition(window)) && size1 > 2) pos1 = 4;
		if (IntRect(1150, 0, 100, 185).contains(Mouse::getPosition(window)) && size1 > 3) pos1 = 5;
		if (IntRect(1250, 0, 100, 185).contains(Mouse::getPosition(window)) && size1 > 4) pos1 = 6;
		if (IntRect(750, 0, 100, 185).contains(Mouse::getPosition(window)) && size1 > 5) pos1 = 7;
		if (IntRect(850, 187, 100, 185).contains(Mouse::getPosition(window)) && size1 > 6) pos1 = 8;
		...
		if (IntRect(750, 372, 100, 185).contains(Mouse::getPosition(window)) && size1 > 7) pos1 = 13;
		if (IntRect(850, 372, 100, 185).contains(Mouse::getPosition(window)) && size1 > 12) pos1 = 14;
		if (IntRect(950, 372, 100, 185).contains(Mouse::getPosition(window)) && size1 > 13) pos1 = 15;
		if (IntRect(1050, 372, 100, 185).contains(Mouse::getPosition(window)) && size1 > 14) pos1 = 16;
		if (IntRect(1150, 372, 100, 185).contains(Mouse::getPosition(window)) && size1 > 15) pos1 = 17;
		if (IntRect(1250, 372, 100, 185).contains(Mouse::getPosition(window)) && size1 > 16) pos1 = 18;
		if (Mouse::isButtonPressed(Mouse::Left) && isClick == true) {
			if (pos1 == 1 && isChecked[18] == false) { spr_check[18].setPosition(750, 0); numChecks1.push_back(pos1); isChecked[18] = true; }
			else if (pos1 == 1) {
			...
			if (pos1 == 2 && isChecked[19] == false) { spr_check[19].setPosition(850, 0); numChecks1.push_back(pos1); isChecked[19] = true; }
			else if (pos1 == 2) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 3 && isChecked[20] == false) { spr_check[20].setPosition(950, 0); numChecks1.push_back(pos1); isChecked[20] = true; }
			else if (pos1 == 3) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 4 && isChecked[21] == false) { spr_check[21].setPosition(1050, 0); numChecks1.push_back(pos1); isChecked[21] = true; }
			else if (pos1 == 4) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 5 && isChecked[22] == false) { spr_check[22].setPosition(1150, 0); numChecks1.push_back(pos1); isChecked[22] = true; }
			else if (pos1 == 5) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 6 && isChecked[23] == false) { spr_check[23].setPosition(1250, 0); numChecks1.push_back(pos1); isChecked[23] = true; }
			else if (pos1 == 6) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 7 && isChecked[24] == false) { spr_check[24].setPosition(750, 187); numChecks1.push_back(pos1); isChecked[24] = true; }
			else if (pos1 == 7) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 8 && isChecked[25] == false) { spr_check[25].setPosition(850, 187); numChecks1.push_back(pos1); isChecked[25] = true; }
			else if (pos1 == 8) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 9 && isChecked[26] == false) { spr_check[26].setPosition(950, 187); numChecks1.push_back(pos1); isChecked[26] = true; }
			else if (pos1 == 9) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 10 && isChecked[27] == false) { spr_check[27].setPosition(1050, 187); numChecks1.push_back(pos1); isChecked[27] = true; }
			else if (pos1 == 10) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 11 && isChecked[28] == false) { spr_check[28].setPosition(1150, 187); numChecks1.push_back(pos1); isChecked[28] = true; }
			else if (pos1 == 11) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 12 && isChecked[29] == false) { spr_check[29].setPosition(1250, 187); numChecks1.push_back(pos1); isChecked[29] = true; }
			else if (pos1 == 12) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 13 && isChecked[30] == false) { spr_check[30].setPosition(750, 372); numChecks1.push_back(pos1); isChecked[30] = true; }
			else if (pos1 == 13) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 14 && isChecked[31] == false) { spr_check[31].setPosition(850, 372); numChecks1.push_back(pos1); isChecked[31] = true; }
			else if (pos1 == 14) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 15 && isChecked[32] == false) { spr_check[32].setPosition(950, 372); numChecks1.push_back(pos1); isChecked[32] = true; }
			else if (pos1 == 15) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 16 && isChecked[33] == false) { spr_check[33].setPosition(1050, 372); numChecks1.push_back(pos1); isChecked[33] = true; }
			else if (pos1 == 16) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 17 && isChecked[34] == false) { spr_check[34].setPosition(1150, 372); numChecks1.push_back(pos1); isChecked[34] = true; }
			else if (pos1 == 17) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
			...
			if (pos1 == 18 && isChecked[35] == false) { spr_check[35].setPosition(1250, 372); numChecks1.push_back(pos1); isChecked[35] = true; }
			else if (pos1 == 18) {
				for (it = numChecks1.begin(); it != numChecks1.end(); it++) {
					if (*it == pos1) it = numChecks1.erase(it);
					if (it == numChecks1.end()) break;
		...
		for (int i = 0; i < numChecks1.size(); i++) {
			window.draw(spr_check[numChecks1[i] - 1]);
		}
		/*for (int i = 0; i < size; i++) {
		...
		window.draw(spr_helpInstrument[2]);
